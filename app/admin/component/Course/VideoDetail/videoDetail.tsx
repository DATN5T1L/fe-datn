...
import ChatCmt from "@/app/giangvien/component/chatDocument/chatCmt";
import FaqList from "@/app/giangvien/component/faqCourse/faqList";
                  ...
                  {item.documents
                    ...
                    .map(doc => (
                      <Button
                        ...
                        className={`${videoMod.chapterBtn} ${doc.document_id === activeDocumentId ? videoMod.infoBg : videoMod.outlineBg}`}
