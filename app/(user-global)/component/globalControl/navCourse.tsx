        ...
        <header>
            <Navbar className={styles.nav} >
                ...
                <div className={styles.cta}>
                    ...
                    <div className={styles.iconNotifition}>
                    ...
                    <Tippy visible={visible} onClickOutside={hide} interactive={true} render={attrs => (
                        <div className={styles.tippyBox} tabIndex={-1} {...attrs}>
                            <div className={styles.menuContent}>
                                <p className={styles.menuTitle}>Tùy chọn</p>
                                <Link href="/profile" className={styles.menuLink}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <p className={styles.menuTitle}>Cài đặt</p>
                        ...
                        <div className={styles.menuOptions} onClick={visible ? hide : show}>
                            <Image src="/img/tuan.png" alt="logo" className={styles.userImage} width={34} height={80} />
                            <h4 className={styles.titleName}>Huỳnh Võ Hoàng Tuấn</h4>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
