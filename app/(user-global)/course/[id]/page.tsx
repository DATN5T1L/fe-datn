...
const CourseDetail: React.FC<{ params: { id: number } }> = ({ params }) => {
    ...
    return (
        <>
            ...
            <section className={`${styles.intructor}`}>
            ...
            <section className={`${styles.whyTTO}`}>
                <Container className={`${styles.container} ${styles.containerWhytto}`}>
                    ...
                    <Row className={`${styles.row} ${styles.rowWhy}`}>
                        <Col md={6} className={styles.contenItem}>
                            <div className={styles.iconWhy}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                                    <g clip-path="url(#clip0_3776_5975)">
                                        <path d="M1.37695 25.623L18.1627 8.83727M21.8928 5.10711L23.7579 3.24203M17.2301 4.17457V1.37695M22.8254 9.76981H25.623M20.9603 13.5L22.8254 15.365M11.6349 4.17457L13.5 6.03965" stroke="white" stroke-width="4.14286" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                        ...
                        <Col md={6} className={styles.contenItem}>
                            <div className={styles.iconWhy}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                    <g clip-path="url(#clip0_3836_23929)">
                        ...
                        <Col md={6} className={styles.contenItem}>
                            <div className={styles.iconWhy}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                    <g clip-path="url(#clip0_3836_23938)">
                            ...
                            <Col md={6} className={styles.FeedbackItem}>
                                <div className={styles.iconFeedback}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="67" viewBox="0 0 90 67" fill="none">
                                        <g clip-path="url(#clip0_3776_2939)">
