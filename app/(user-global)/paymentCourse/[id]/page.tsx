...
const CourseDetail: React.FC<{ params: { id: string } }> = ({ params }) => {
    ...
    const fetchPayMentVn = async () => {
        try {
            const response = await fetch(`/api/paymentvnp/${id}/20`, {
                method: "POST",
                headers: {
